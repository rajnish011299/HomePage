...
public class MainActivity extends AppCompatActivity {
    ...
    int[] source={R.drawable.minion,R.drawable.sunflower,R.drawable.scene,R.drawable.stone,R.drawable.lake};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerVIew = (RecyclerView)findViewById(R.id.homeView);
